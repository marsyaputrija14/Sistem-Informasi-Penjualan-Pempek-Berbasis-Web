...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('assets_home/fonts/flat-icon/flaticon.css'); ?>">
	...
	<header class="header-area header-area2">
		<div class="container">
			<div class="row">
				<div class="col-lg-2">
					<div class="logo-area">
						<a href="<?php echo base_url(); ?>"><img style="width: 60%;height:80px;border-radius:10%;" src="<?= base_url('assets_home/logo.png') ?>" alt="logo"></a>
					</div>
				</div>
				<div class="col-lg-10">
